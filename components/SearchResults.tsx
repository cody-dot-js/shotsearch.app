...
export const SearchResults = ({
  ...
  images == null ? null : (
    <article className="mt-5 md:mt-0 md:col-span-2 mb-4 bg-white">
      <div className="shadow sm:rounded-md sm:overflow-hidden">
        <header className="shadow">
          <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h2 className="mr-4 mb-0 text-2xl font-bold leading-tight text-gray-900">
...
const ImagePreviews = ({ images = [] }: { images: ImageMeta[] }) =>
  images.length === 0 ? null : (
    <ul className="p-4 grid grid-cols-4 gap-1">
